...
<!-- Mirrored from mentoring-mobile.dreamguystech.com/bootstrap4/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Aug 2021 04:39:23 GMT -->
<head>
<meta charset="utf-8" />
...
<div class="list">
<div class="back-btn">
<a href="<?php echo base_url('mobile/login');?>" class="back link">
<i class=" feather-arrow-left"></i>
</a>
</div>
<form action="https://mentoring-mobile.dreamguystech.com/bootstrap4/login.html">
...
<li>
<div class="form-group">
<button type="button" class="btn btn-submit btn-primary w-100">Daftar</button>
</div>
</li>
</ul>
<div class="login-or">
...
<div class="text-center dont-have mt-4">Sudah punya akun? <a href="login.html">Login</a></div>
</div>
</form>
</div>
</div>
