	...
	<header style="border-bottom:1px solid #e7e7e7">
		<div class="container">
			<div class="d-flex justify-content-between align-items-center">
				<div class="left">
					<a href="<?php echo base_url('mobile/enduser/toko_terdekat');?>" class="btn btn-default btn-circle btn-circle-sm m-1" style="background-color:#fff;color:#000"><i class="fa fa-arrow-left"></i></a> <b>Store</b>
				</div>
				<div class="">
					<a href="<?php echo base_url('mobile/enduser/toko_terdekat');?>" class="btn btn-default btn-circle btn-circle-sm m-1" style="background-color:#fff;color:#003399"><i class="fa fa-shopping-cart"></i></a> 
				</div>
