...
class referensi_pengukuran extends HX_Controller {

   public $_subj  = 'Refrensi Pengukuran';
   public $_ctrl  = 'referensi_pengukuran';
   public $_tabel = 't_pengukuran';
   public $_kunci = 't_pengukuran_id';
   public $limit =100;
   ...
   {
	  $produk = $this->mm->get('t_produk');
	  $produk_list = array();
	  foreach($produk as $r){
		  $produk_list[$r['t_produk_id']] = $r['t_produk_nm'];
	  }
	  
       //tabel
      if ($tipe=='tabel') {
		  $field['t_produk_id']      = array('label'=>'Produk','tipe'=>'array','list'=> $produk_list );
         $field['t_pengukuran_harga_permeter']      = array('label'=>'Harga permeter persegi','tipe'=>'rupiah');
      ...
      //form
		   ...
		   $field['t_produk_id']      = array('label'=>'Produk','tipe'=>'select','list'=> $produk_list );
		  $field['t_pengukuran_harga_permeter']      = array('label'=>'Harga permeter persegi','tipe'=>'rupiah');
	...
	public function index($offset=null)
	{
     ...
     $load['tambah']='yes';
      ...
      $param['like']   = $like;
      $param['order']  = 't_pengukuran_id ASC';
