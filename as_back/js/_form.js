 var editor = new FroalaEditor('.editorfroala', {
    tabSpaces: 4
  })
						...
						$.ajax({
						   ...
						   success: function(data){
							   var kodes = JSON.parse(data);
									   ...
									   document.getElementById("select2-peringkat-container").innerHTML = kodes.m;
									   document.getElementById("select2-kesehatan-container").innerHTML = kodes.n;
